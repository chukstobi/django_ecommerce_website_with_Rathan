...
def register(request):
    if request.method == "POST":
            ...
            if form.is_valid():
                ...
                send_email.send()
                messages.success(request, "Thank you for registering with us. We have sent you a verification email to your provided email address to activate your account.")
...
def forgot_password(request):
    if request.method == "POST":
        ...
        if Account.objects.filter(email = email).exists():
            ...
            messages.success(request, "A link to reset your password has been forwarded to your email address.")
            return redirect('login')
